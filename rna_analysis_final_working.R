...
# RNA/Cytokine Analysis Script - Final Working Version
...
# Function to clean Excel data - Final working approach
...
# Function to identify sample groups - Fixed version
identify_groups <- function(data) {
  ...
  groups <- sapply(sample_ids, function(id) {
    if (grepl("^S", id)) "Group_S" else "Group_U"
  })
