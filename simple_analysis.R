...
# Simple RNA/Cytokine Analysis Script
...
# Simple approach: read data directly and manually process
...
c2_groups <- ifelse(substr(c2_data$Sample_ID, 1, 1) == "S", "Group_S", "Group_U")
p2_groups <- ifelse(substr(p2_data$Sample_ID, 1, 1) == "S", "Group_S", "Group_U")
